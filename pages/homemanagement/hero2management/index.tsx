...
function Index() {
  ...
  useEffect(() => {
    try {
      axios.get(`http://localhost:3006/homepage/chinhhang`).then((res) => {
  ...
  return (
    <div className='my-6'>
      <Breadcrumb aria-label="Default breadcrumb example" className="my-6">
        ...
        <Breadcrumb.Item>Chính Hãng Management</Breadcrumb.Item>
      </Breadcrumb>

      <h1 className="mb-6 font-bold uppercase text-xl text-center">
      Chính Hãng management
      </h1>
                        ...
                        <a
                          ...
                          onClick={() => {
                            ...
                            try {
                              axios
                                .get(
                                  `http://localhost:3006/homepage/chinhhang/${category.id}`
                                )
                                .then((res) => {
                            ...
                            <a
                              ...
                              onClick={() => {
                                try {
                                  axios
                                    .patch(
                                      `http://localhost:3006/homepage/chinhhang/${categoryByid.id}`,
                                      {
                                        name:
